...
const NewUploadEdi = ({ intermediateJSON, setintermediateJSON }) => {
   const [files, setFiles] = React.useState([]);
    ...
    const handleSubmit = async (event) => {
      ...
      for (let file of files) {
       ...
       console.log("hi this is from data",formData)
      ...
      try {
        if (response.status === 200) {
          ...
          console.log("hi this is tanmay bhosdike data",data)
